                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex">
                        <div class="form-check me-4">
                            <input class="form-check-input" type="radio" name="source_pointage" id="source_manuel" value="manuel" {{ old('source_pointage', 'manuel') == 'manuel' ? 'checked' : '' }}>
                            <label class="form-check-label" for="source_manuel">
                                <i class="bi bi-person-fill"></i> Manuel
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="source_pointage" id="source_biometrique" value="biometrique" {{ old('source_pointage') == 'biometrique' ? 'checked' : '' }}>
