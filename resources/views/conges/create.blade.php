            ...
            <div class="row g-3">
                <div class="col-md-12">
                    ...
                    <select class="form-select @error('employe_id') is-invalid @enderror" id="employe_id" name="employe_id" required>
                        ...
                        @foreach($employes as $employe)
                            <option value="{{ $employe->id }}" {{ old('employe_id', auth()->user()->employe_id) == $employe->id ? 'selected' : '' }}>
                ...
                <div class="col-md-12">
                    ...
                    <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                        ...
                        <option value="conge_paye" {{ old('type') == 'conge_paye' ? 'selected' : '' }}>Congé payé</option>
                ...
                <div class="col-12 mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-save"></i> Soumettre la demande
                    </button>
                    <a href="{{ route('conges.index') }}" class="btn btn-secondary">
